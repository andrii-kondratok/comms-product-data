...
| `rank_daily` | щогодини, :55 | топ-30 дня: тема + схожість на взірці, без рутини, одна стаття на подію, без того, про що вже писали |
...
- `marts.covered_today`: що прибрано як «ми про це вже писали»
